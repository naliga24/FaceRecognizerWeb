...
class TeacherSearch extends Component {
    constructor() {
       ...
       // stateLocal && (this.state=Object.assign({}, this.state, JSON.parse(stateLocal) ) )
        ...
        this.searchTeacher1 = this.searchTeacher1.bind(this)
    ...
    searchTeacher() {
        let search = this.state.search.set('teacherFirstName', this.state.tmpTeacherFirstName)
        ...
        teacherObj.listSearchTeacher(this.state.search) 
        window.setTimeout(() => {
            this.setState({dataListTeacher:teacherObj.returnListSearchTeacher})
            teacherObj.returnListSearchTeacher.length === 0 && alertify.alert('ค้นหา','ไม่พบข้อมูลที่ค้นหา',()=>{
            ...
            <div class='outer'>
                ...
                <div class='teacher_search'>
                    ...
                    <ReactTable
                        ...
                        data={this.state.dataListTeacher ? this.state.dataListTeacher : []}
                        defaultPageSize={8}
